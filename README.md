...
- 공식사이트 - https://mahapps.com/
    ...
    - 2011년 개발 시작, 2014년 배포. 현재 버전 2.4.10 
...
- 기본 사용법 - [소스](./day09/Day09Study/WpfStudyApp02/MainWindow.xaml)
    ...
    - VS Extension for WPW UI
        - 메뉴 확장 > 확장 관리
        - WPF-UI 검색 후 설치
        - VS 종료
        - VSIS Installer 시작 > Modify
    - VS Propject > WPF UI 프로젝트 선택
    ...
    - Theme를 Dark로 했을 경우
        - Window 전체 Background를 어두운 색으로 지정 후 작성
...
#### 2. 미니 게임 만들기
- tic tac toe
    - 3x3 오목 - 먼저 한 줄을 만드는 사람이 이김

- memory game
    - 난이도 3단계까지 구성

- Whack A Mole (두더지 잡기)
    - 제한 시간30초 내에 많은 두더지 잡기