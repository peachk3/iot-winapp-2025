namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(BtnModal, "모달창 연습 버튼입니다."); // 툴팁 설정
            toolTip1.SetToolTip(TxtYear, "달력 선택 년도 표시 텍스트박스입니다."); // 툴팁 설정
        ...
        private void ChangeFont()
        {
            ...
            if (ChkItalic.Checked) style |= FontStyle.Italic; // FontStyle.Regular | FontStyle.Italic; =? 0001 | 0010 = 0011

            // CboFonts 에서 선택된 글자로, 글자크기 12, 글자체 스타일 적용
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frmModal.Width = 300;
            frmModal.Height = 100;
            frmModal.BackColor = Color.Aquamarine;
            frmModal.StartPosition = FormStartPosition.CenterParent; // 부모창의 정중앙
            frmModal.ShowDialog(); // 모달창을 띄운다
        }
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frmModaless.BackColor = Color.Coral;
            ...
            frmModaless.Show(this); // 모달리스 창을 띄운다
        }

        private void BtnMsgBox_Click(object sender, EventArgs e)
        {
            // 메시지박스 -> 모달창
            MessageBox.Show(TxtResult.Text, "텍스트박스 문장", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        }
